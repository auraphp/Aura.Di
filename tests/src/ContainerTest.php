...
class ContainerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetSerialized()
    {
        ...
        $expect = 'O:17:"Aura\\Di\\Container":7:{s:9:"' . "\0" . '*' . "\0" . 'config";O:14:"Aura\\Di\\Config":3:{s:9:"' . "\0" . '*' . "\0" . 'params";C:11:"ArrayObject":21:{x:i:0;a:0:{};m:a:0:{}}s:9:"' . "\0" . '*' . "\0" . 'setter";C:11:"ArrayObject":21:{x:i:0;a:0:{};m:a:0:{}}s:10:"' . "\0" . '*' . "\0" . 'unified";a:0:{}}s:9:"' . "\0" . '*' . "\0" . 'params";r:3;s:9:"' . "\0" . '*' . "\0" . 'setter";r:7;s:7:"' . "\0" . '*' . "\0" . 'defs";a:0:{}s:11:"' . "\0" . '*' . "\0" . 'services";a:0:{}s:9:"' . "\0" . '*' . "\0" . 'locked";b:0;s:12:"lazy_factory";O:24:"Aura\\Di\\Lazy\\LazyFactory":0:{}}';
        $this->assertSame($expect, $actual);
